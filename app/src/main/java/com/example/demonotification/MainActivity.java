...
public class MainActivity extends AppCompatActivity {
    Button btnNotify1,btnNotify2,btnExtraActivity;
    int requestCode = 123;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnExtraActivity = findViewById(R.id.btnTryExtraActivity);
        ...
        btnExtraActivity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                NotificationManager notificationManager = (NotificationManager)
                        getSystemService(NOTIFICATION_SERVICE);
                ...
                builder.setContentText("Birds flying high, you know how I feel Sun in the sky, you know how I feel Reeds driftin' on by, you know how I feel It's a new dawn, it's a new day, it's a new life for me Yeah~ it's a new dawn, it's a new day, it's a new life for me ooooooooh... And I'm feeling good");
                builder.setSmallIcon(android.R.drawable.btn_star_big_off);
                builder.setContentIntent(pIntent);
                builder.setStyle(bigText);
                builder.setAutoCancel(true);
